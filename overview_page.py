...
def main():
    ...
    start_date = cols[0].date_input("开始日期",value=datetime.strptime('2022-01-01','%Y-%m-%d'),max_value=datetime.now())
    ...
    total_buy_amount = selected_df[selected_df['amount']>0]['amount'].sum()
